...
I'm a generalist with experience in back end databases and software architecture through front end JavaScript and CSS. Whether it is Python or Javascript, SQL or NoSQL, OOP or FP, .NET or Java, Mac, *nix or Windows---I belive in using the right tool for the job, even if it means getting out of my comfort zone.
}
\vspace{0.15in}
